                            ...
                            <Container>
                                <Form onSubmit={handleSubmit}>
                                    ...
                                    <FormGroup className="mt-5">
                                        <Label for="exampleEmail" className="bold_txt">Email</Label>
                                        <Input type="email" onChange={handleChange} name="email" id="exampleEmail" placeholder="Enter your E-mail" />
                                    </FormGroup>
                                    <FormGroup>
                                        <Label for="examplePassword" className="bold_txt">Password</Label>
                                    ...
                                    <div className="submit-btn d-flex justify-content-center">
                                        <Button color="dark" type="Submit" className="submit mt-1 mb-1" /*disabled={!isSignup}*/ >
                                            Submit
                                        </Button>
                                    </div>
